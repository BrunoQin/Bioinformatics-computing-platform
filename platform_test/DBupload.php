...
<div id="cl-wrapper" class="fixed-menu"><!--Sidebar item function--><!--Sidebar sub-item function-->
  ...
  <div id="pcont" class="container-fluid">
    ...
    <div class="cl-mcont">
      <form id="my-awesome-dropzone" method="post" class="dropzone" enctype="multipart/form-data">
        <div class="dz-message">
          <h2>点击此处上传或将文件拖动到此处</h2>
          <h3>文件名不可含有中文</h3>
        </div>
      </form>
    </div>
